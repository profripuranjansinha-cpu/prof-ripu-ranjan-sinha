  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "navy-md": "0 8px 32px -8px oklch(0.15 0.07 252 / 0.4)",
        "navy-lg": "0 20px 60px -10px oklch(0.15 0.07 252 / 0.5)",
        "gold-glow": "0 0 30px -5px oklch(0.75 0.145 78 / 0.5)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
